...
void FLinterContentBrowserExtensions::InstallHooks(FLinterModule* LinterModule, FDelegateHandle* pContentBrowserExtenderDelegateHandle, class FDelegateHandle* pAssetExtenderDelegateHandle)
{
	struct Local
	{
		...
		{
			MenuBuilder.BeginSection("PositiveLinterContentBrowserContext", LOCTEXT("CB_LinterHeader", "PositiveLinter"));
			{
				MenuBuilder.AddMenuEntry(
					LOCTEXT("CB_ScanProjectWithLinter", "Scan with PositiveLinter"),
					LOCTEXT("CB_ScanProjectWithLinter_Tooltip", "Scan project content with PositiveLinter"),
					...
					FGlobalTabmanager::Get()->TryInvokeTab(FTabId(FName("PositiveLinterTab")));
						}
					})),
					NAME_None,
		...
		{
			MenuBuilder.BeginSection("PositiveLinterAssetContext", LOCTEXT("CB_LinterHeader", "PositiveLinter"));
			{
