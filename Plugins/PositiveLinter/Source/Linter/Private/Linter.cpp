...
static const FName LinterTabName = "PositiveLinterTab";
...
void FLinterModule::StartupModule()
{
	...
	if (!IsRunningCommandlet())
	{
		...
		{
			SettingsModule->RegisterSettings("Project", "Plugins", "PositiveLinter",
				LOCTEXT("RuntimeSettingsName", "PositiveLinter"),
				LOCTEXT("RuntimeSettingsDescription", "Configure the PositiveLinter plugin"),
...
void FLinterModule::ShutdownModule()
{
	if (ISettingsModule* SettingsModule = FModuleManager::GetModulePtr<ISettingsModule>("Settings"))
	{
		SettingsModule->UnregisterSettings("Project", "Plugins", "PositiveLinter");
	}
